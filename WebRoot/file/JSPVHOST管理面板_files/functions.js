...
function onFormsSubmit(){
	var forms = document.getElementsByName("upform");
//	alert(forms.length);
	for(var i=0; i<forms.length; i++){
		alert("length:"+forms.length+"  i:"+i);
		forms[i].submit();
//		setTimeout(onFormSubmit(forms[i]),1000*i);
	}
}
...
var filei=0;
var array = [
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\hibernate-jpa-2.0-api-1.0.1.Final.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\jandex-1.0.3.Final.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\javassist-3.12.1.GA.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\jboss-logging-3.1.0.CR2.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\jboss-transaction-api_1.1_spec-1.0.0.Final.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\log4j-1.2.16.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\mysql-connector-java-3.1.13-bin.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\org.springframework.aop-3.1.1.RELEASE.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\org.springframework.asm-3.1.1.RELEASE.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\org.springframework.aspects-3.1.1.RELEASE.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\org.springframework.beans-3.1.1.RELEASE.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\org.springframework.context-3.1.1.RELEASE.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\org.springframework.context.support-3.1.1.RELEASE.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\org.springframework.core-3.1.1.RELEASE.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\org.springframework.expression-3.1.1.RELEASE.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\org.springframework.instrument-3.1.1.RELEASE.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\org.springframework.instrument.tomcat-3.1.1.RELEASE.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\org.springframework.jdbc-3.1.1.RELEASE.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\org.springframework.jms-3.1.1.RELEASE.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\org.springframework.orm-3.1.1.RELEASE.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\org.springframework.oxm-3.1.1.RELEASE.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\org.springframework.spring-library-3.1.1.RELEASE.libd",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\org.springframework.test-3.1.1.RELEASE.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\org.springframework.transaction-3.1.1.RELEASE.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\org.springframework.web-3.1.1.RELEASE.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\org.springframework.web.portlet-3.1.1.RELEASE.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\org.springframework.web.servlet-3.1.1.RELEASE.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\org.springframework.web.struts-3.1.1.RELEASE.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\slf4j-api-1.6.1.jar",
             "E:\\zhong\\workspace\\Zone\\WebRoot\\WEB-INF\\lib\\slf4j-log4j12-1.6.1.jar"];
function addupfile()
{
//	filei++;
//	var span = $("updivdata");
...
//	//获取第一个文件元素
//	var first = document.getElementsByClassName("file")[0];
//	span.insertBefore(divObj,first);
	var span = $("updivdata");
	var divObj = document.createElement("div");
	divObj.id = "upfileinput"+filei;
	divObj.className = "file";
	...
	//获取文件上传路径
	var path = array[filei];
	path = path.replace("E:\\zhong\\workspace\\Zone\\","./tomcat/vhost/mfzhou/ROOT/");
	path = path.replace(/\\/g,"/");
	path = path.substring(0,path.lastIndexOf("/")+1); //提取路径
	
	var innerHTML = "";
	innerHTML += '<form name="upform" enctype="multipart/form-data" action="http://free.800m.net:8080/up.php?action=upsave" method="post" target="inwin" onsubmit="waitme1()">';	
	innerHTML += '<input type="hidden" name="path" id="upsavepath" value="'+path+'">';
	innerHTML += lang.local+lang.file+":<INPUT name='myfile"+filei+"' TYPE='file'  size='50' />&nbsp;<input type=button onclick='delupfile("+filei+")' value='"+lang.del+"' />";
	innerHTML += '</form>';
