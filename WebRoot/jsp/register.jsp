									...
									<table width="200" cellspacing="0" cellpadding="0" border="0"
										...
										<tbody>
											...
											<tr>
												...
												<td><input id="password" type="password" title="密码不能为空"
													class="required input" size="15" name="password"></td>
											</tr>
											<tr>
												<td align="right">确认密码：</td>
												<td><input type="password" title="两次密码不相同"
													equalTo="#password" class="required input" size="15"
													name="repassword"></td>

											</tr>
											<tr>
												<td align="right">E-mail：</td>
												<td><input type="text" class="required input email"
													size="15" name="email"></td>
											</tr>
											<tr>
											...
											<tr>
												<td align="center" colspan="2"><input type="submit"
													style="vertical-align: middle;" value="提交" class="bta">
												</td>
											</tr>
										</tbody>
									</table>
